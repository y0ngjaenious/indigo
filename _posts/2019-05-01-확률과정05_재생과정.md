...
![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/blob/master/_posts/img/9.1.PNG)

의 관계가 있으므로, 위 식의 각 항을 $N(t)$로 나누면,

![math](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.2.PNG)
...
![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.3.PNG)

이 성립한다. 또한, 부등식의 모든 변에 극한을 취하면,

![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.4.PNG)
...
![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.5.PNG)
...
![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.6.PNG)

이라고 두고 만약 $E[R]<\infty, E[X]<\infty$이면,

![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.7.PNG)

이 성립하고, 여기에 강대수법칙을 적용하면,

![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.8.PNG)

이고,

![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.9.PNG)

이므로,

![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.10.PNG)
...
![](https://github.com/y0ngjaenious/y0ngjaenious.github.io/tree/master/_posts/img/9.11.PNG)
